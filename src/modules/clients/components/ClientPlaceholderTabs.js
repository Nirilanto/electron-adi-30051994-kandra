// src/modules/clients/components/ClientTabNavigation.js
...
const ClientTabNavigation = ({ activeTab, setActiveTab }) => {
  const tabs = [
    { 
      id: 'informations', 
      label: 'Informations', 
    ...
    { 
      ...
      description: 'Détails commerciaux et financiers'
    },
    { 
      id: 'historique', 
      label: 'Historique', 
      icon: DocumentTextIcon,
      description: 'Contrats et projets réalisés'
    },
    { 
      id: 'pointage', 
      label: 'Pointage', 
      icon: ClockIcon,
      description: 'Suivi des heures et facturation'
    }
  ];
