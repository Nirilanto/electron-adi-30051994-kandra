// src/modules/employees/components/ModernTabNavigation.js
...
const ModernTabNavigation = ({ activeTab, setActiveTab }) => {
  const tabs = [
    { 
      id: 'informations', 
      label: 'Informations', 
    ...
    { 
      ...
      label: 'À propos', 
      icon: UserIcon,
      description: 'Détails professionnels et documents'
    },
    { 
      id: 'historique', 
      label: 'Historique', 
      icon: DocumentTextIcon,
      description: 'Contrats et missions passées'
    },
    { 
      id: 'pointage', 
      label: 'Pointage', 
