...
import { EmployeeHistoryTab, EmployeeTimeTrackingTab } from './components/PlaceholderTabs';
...
function EmployeeProfile() {
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'pointage':
        return <EmployeeTimeTrackingTab />;
      default:
        return <EmployeeInfoTab employee={employee} />;
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg text-gray-600 font-medium">Chargement du profil...</p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-rose-100 flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Employé non trouvé</h2>
          <p className="text-gray-600">L'employé demandé n'existe pas ou a été supprimé.</p>
        </div>
      </div>
    );
  }
